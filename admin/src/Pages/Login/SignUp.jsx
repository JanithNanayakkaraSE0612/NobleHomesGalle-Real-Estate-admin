...
const SignUp = () => {
  ...
  return (
    <div className="w-full h-screen flex items-start">
      {/* Right side with Login Form (Previously on the left side) */}
      <div className="w-1/2 h-full bg-[#F5F5F5] flex flex-col p-20 justify-center items-center">
        <div className="mb-6 text-center">
          <h1 className="text-[15px] font-bold uppercase font-moul">
            Homescape
          </h1>
          <span className="tracking-widest text-[15px] font-bold uppercase font-moul">
            H a v e n
          </span>
        </div>
      ...
      {/* Left side with Image (Previously on the right side) */}
