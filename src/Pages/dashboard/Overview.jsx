...
const Overview = () => {
  ...
  useEffect(() => {
    const fetchHomes = async () => {
      ...
      const homesList = homesSnapshot.docs.map((doc) => ({ id: doc.id, ...doc.data() }));
      setHomes(homesList);
    };
  ...
  return (
    <div className="p-5">
      <h2 className="text-4xl font-extrabold text-center mb-4 text-gray-800">Noble Homes</h2>
      <p className="text-center text-xl mb-6 text-gray-600">Your trusted platform for premium real estate</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {homes.length > 0 ? (
          ...
          <p className="text-center text-xl text-gray-600">No homes listed yet.</p>
        )}
      </div>

      {/* EditHome modal */}
      {isEditing && selectedHome && <EditHome home={selectedHome} onClose={closeEditModal} />}
      ...
      {isDeleteModalOpen && (
        <div className="fixed inset-0 flex justify-center items-center bg-gray-500 bg-opacity-50 z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg w-1/3">
            ...
            <p className="text-gray-600 mb-4">Are you sure you want to delete this home?</p>
            <div className="flex justify-between">
              <button
